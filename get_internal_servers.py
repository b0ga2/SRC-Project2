...
up_bytes = data.groupby(['src_ip','port', 'proto'])['up_bytes'].sum().sort_values(ascending=False)
down_bytes = data.groupby(['src_ip','port', 'proto'])['down_bytes'].sum().sort_values(ascending=False)
