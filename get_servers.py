...
up_bytes = data.groupby(['dst_ip'])['up_bytes'].sum().sort_values(ascending=False)
down_bytes = data.groupby(['dst_ip'])['down_bytes'].sum().sort_values(ascending=False)
...
servers_up = newdata.loc[newdata['dst_public'] == True].groupby(['dst_ip'])['up_bytes'].sum()
servers_down = newdata.loc[newdata['dst_public'] == True].groupby(['dst_ip'])['down_bytes'].sum()
